...
const RuntimeJavaVulnerabilitiesInventoryComponent = () => {
  ...
  const DocViewInspectButton = ({
    ...
    const inspectHintMsg = 'Inspect runtime Java vulnerability details';
    return (
  ...
  const dataGridProps = useDataGrid({
    moduleId: 'runtime-java-vulnerabilities-inventory',
    ariaLabelledBy: 'Runtime Java Vulnerabilities Inventory Table',
    defaultColumns: runtimeJavaVulnerabilitiesDefaultColumns,
          ...
          <>
            ...
            {inspectedHit && (
              <EuiFlyout onClose={closeFlyoutHandler} size='m'>
                <EuiFlyoutHeader>
                  <EuiTitle>
                    <h2>Runtime Java vulnerability details</h2>
                  </EuiTitle>
                </EuiFlyoutHeader>
                <EuiFlyoutBody>
                  <EuiFlexGroup direction='column'>
                    <DocumentViewTableAndJson
                      ...
                      renderFields={getAllCustomRenders(
                        runtimeJavaVulnerabilitiesDefaultColumns,
...
export const RuntimeJavaVulnerabilitiesInventory = compose(
  withErrorBoundary,
  withRuntimeJavaVulnerabilitiesStateDataSource,
)(RuntimeJavaVulnerabilitiesInventoryComponent);
